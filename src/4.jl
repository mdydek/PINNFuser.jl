...
function NIK_PINN!(du, u, p, t)
    ...
    alfa = 0.1
    du[1] = ((Qmv - Qav) * elastance + pLV / elastance * delastance) * (1 + alfa * periodic_correction(NN_output[1], t))
    ...
    du[5] = (simpleModel.Valve(Zao, (du[1] - du[2]), u[1] - u[2])) * (1 + alfa * periodic_correction(NN_output[5], t))  # AV 
    du[6] = (simpleModel.Valve(Rmv, (du[3] - du[1]), u[3] - u[1])) * (1 + alfa *periodic_correction(NN_output[6], t))  # MV
