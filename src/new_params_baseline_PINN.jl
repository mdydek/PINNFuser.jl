...
loaded_data = readdlm("data/new_params_original_data.txt")
...
println("Pinn extrapolation saved to new_params_baseline_pinn_extrapolation.txt")
writedlm("data/new_params_baseline_pinn_extrapolation.txt", data_to_save)
