...
@time simple_sol =
    solve(prob, Tsit5(), saveat = tsteps, reltol = 1e-4, abstol = 1e-7, dtmax = 1e-2)
...
# writedlm("../data/new_params_simple_data.txt", data_to_save)
# println("Data saved to new_params_simple_data.txt")

writedlm("../data/new_params_simple_extrapolation.txt", data_to_save)
println("Data saved to new_params_simple_extrapolation.txt")
